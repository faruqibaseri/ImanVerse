...
<body>
    ...
    <section class="main-section">
        <h1>Quotes</h1>
        <p class="description">Inspiring Islamic quotes to uplift and guide your spiritual journey.</p>
        ...
        <!-- button download -->
         ...
         <div id="wrap">
            <?php $filename = 'Quotes Collection.zip';
          ...
          <div class="blocks">
            <div class="block" onclick="showImage('Quotes 1.png')">
                <img src="Quotes 1.png" alt="Quotes 1">

            </div>
            
            <div class="block" onclick="showImage('Quotes 2.png')">
            <img src="Quotes 2.png" alt="Quotes 2">
                
            </div>
            
            <div class="block" onclick="showImage('Quotes 3.png')">
                <img src="Quotes 3.png" alt="Quotes 3">

            </div>

            <div class="block" onclick="showImage('Quotes 4.png')">
                <img src="Quotes 4.png" alt="Quotes 4">

            </div>
            
            <div class="block" onclick="showImage('Quotes 5.png')">
            <img src="Quotes 5.png" alt="Quotes 5">
                
            </div>
            
            <div class="block" onclick="showImage('Quotes 6.png')">
                <img src="Quotes 6.png" alt="Quotes 6">

            </div>

            <div class="block" onclick="showImage('Quotes 7.png')">
                <img src="Quotes 7.png" alt="Quotes 7">

            </div>
            
            <div class="block" onclick="showImage('Quotes 8.png')">
            <img src="Quotes 8.png" alt="Quotes 8">
                
            </div>
            
            <div class="block" onclick="showImage('Quotes 9.png')">
                <img src="Quotes 9.png" alt="Quotes 9">

            </div> 
        </div>
    <div style="display: flex;margin-top:50px;justify-content: center;gap: 20px;" >        
        <a href="learn_doa.php" class="btn" style="margin-left: 0px;margin-right: 0px;"> <i class="fa-solid fa-angle-left"></i></a>
        <a href="learn_fiqh.php" class="btn"style="margin-left: 0px;margin-right: 0px;"> <i class="fa-solid fa-angle-right"></i></a>
</div>
